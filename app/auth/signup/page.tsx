      ...
      <div className="w-full max-w-lg">
        <div className="text-center mb-10">
          <div className="flex flex-col items-center justify-center gap-4 mb-8">
            ...
            <div>
              ...
              <span className="text-[10px] font-bold text-gray-400 tracking-[0.4em] uppercase mt-1">Únete hoy</span>
            </div>
          </div>
          ...
          <p className="text-text-muted font-medium">
            Forma parte de la red de aliados más grande del país
          </p>
        </div>

        <div className="bg-white border border-gray-100 rounded-[3rem] p-12 shadow-2xl shadow-primary/5 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-full h-2 bg-gradient-to-l from-primary via-gold to-primary"></div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-text-muted font-medium">
            ¿Ya tienes una cuenta? <a href="/auth/login" className="text-primary font-black hover:underline">Inicia Sesión</a>
          </p>
        </div>
      </div>
    </div>
